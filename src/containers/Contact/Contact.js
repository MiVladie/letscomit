...
const Contact = () => {
    ...
    const onSubmitHandler = (values) => {
        ...
        let url = 'https://access-server.herokuapp.com/message/letscomit/';
    ...
    return (
    	<React.Fragment>    		
            ...
            <IntroLarge
                main = "Let's get to the next level together" />
            ...
            <Intro
                main = 'prefer email or phone?'
                description = { 'letscomit@gmail.com | +44 73422 16193' } />

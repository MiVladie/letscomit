...
const message = ({ message, back, remove }) => {
    let name = message.firstName + (message.lastName ? ' ' + message.lastName : '');
    let company = message.companyName;
    ...
    return (
    	<section className = { classes.Message }>
            <div className = { classes.Row }>
                ...
                { company && <div className = { classes.Description }>
                    <p className = { classes.Name }>Company: <span className = { classes.Text }>{ company }</span></p>
                </div> }
            </div>
